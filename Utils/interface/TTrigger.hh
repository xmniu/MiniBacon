#ifndef MINIBACON_DATAFORMATS_TTRIGGER_HH
#define MINIBACON_DATAFORMATS_TTRIGGER_HH

#include "MiniBacon/Utils/interface/TriggerRecord.hh"       // class to handle user specified trigger info
